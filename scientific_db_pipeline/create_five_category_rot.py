...
def create_five_category_rot():
    """
    Converts the existing 2-category ROT system to a 5-category system.
    """
    try:
        ...
        output_file = 'sorted_rot/all_papers_with_five_categories.csv'
        ...
        logging.error(f"Error creating five category ROT: {e}")
        return False

if __name__ == '__main__':
    create_five_category_rot() 